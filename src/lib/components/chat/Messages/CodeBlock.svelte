...
<div>
	<div class="relative {className} flex flex-col rounded-lg border border-[#f9f9f9] dark:border-gray-300 shadow-md" dir="ltr">
		{#if lang === 'mermaid'}
			{#if mermaidHtml}
				<SvgPanZoom
		...
		{:else}
			...
			<div
				class="sticky {stickyButtonsClassName} mb-1 py-1 pr-2.5 flex items-center justify-end z-9 text-xs text-black dark:text-white"
			>
			...
			>
				<div class=" pt-7 bg-gray-300 dark:bg-[#0d1117]"></div>
				<CodeEditor
					value={code}
					{id}
					{lang}
