...
>
	...
	<slot name="content">
		<DropdownMenu.Content
			class="w-full border dark:border-gray-300 {className} text-sm rounded-xl px-1 py-1.5 z-50 bg-white dark:bg-gray-850 dark:text-white shadow-lg font-primary"
			sideOffset={8}
			side="bottom"
			align="start"
