...
<div class="sticky bg-white dark:bg-dark-900 sm:dark:bg-dark-700 top-0 z-30 w-full px-1.5 py-2 -mb-8 flex items-center">
			...
			<div class="self-start flex flex-none items-center gap-1 text-gray-600 dark:text-gray-400">
				...
				{:else if $mobile}
					<Tooltip content={$i18n.t('Controls')}>
						...
						>
							<div class="m-auto self-center">
								<AdjustmentsHorizontal className="size-6" strokeWidth="0.5" />
							</div>
						</button>
					</Tooltip>
				{/if}
